...
import pandas as pd
import hashlib
#imported all the necessary libraries necessary for the challenge
################################################################################
# Step 1:
...
# `amount` attributes
# YOUR CODE HERE
#Creating a new class named Record with sender and receiver bing string and amount being float
@dataclass
class Record:
    sender: str
    receier: str
...
class Block:
    ...
    # this is the class that has been defined in line 55
    record: Record
...
#added all the text areas to the file
# @TODO:
# Delete the `input_data` variable from the Streamlit interface.
#deleted the input_data varaible 

# @TODO:
# Add an input area where you can get a value for `sender` from the user.
input_area=st.text_area("Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_area2=st.text_area("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_area3=st.text_area("Amount")
